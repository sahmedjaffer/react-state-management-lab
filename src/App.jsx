...
export default function App() {
  ...
  const totalStrength = team.reduce((acc, f) => acc + f.strength, 0);
  const totalAgility = team.reduce((acc, f) => acc + f.agility, 0);
    ...
    <div style={{ padding: "20px", fontFamily: "sans-serif" }}>
      ...
      <ul style={{ display: "flex", flexWrap: "wrap", gap: "10px", listStyle: "none", padding: 0 }}>
        {zombieFighters.map((fighter) => (
          <li key={fighter.id} style={{ border: "1px solid black", padding: "10px", width: "150px" }}>
